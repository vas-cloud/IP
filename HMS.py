...
def Home():
	...
	print("\t\t\t\t\t\t WELCOME TO HOTEL OF VAIBHAV KANOJIA\n")
	print("\t\t\t Press 1 --> Booking\n")
	print("\t\t\t Press 2 --> Rooms Information\n")
	print("\t\t\t Press 3 --> Room Service i.e (Menu Card)\n")
	print("\t\t\t Press 4 --> Payment\n")
	print("\t\t\t Press 5 --> Record\n")
	print("\t\t\t Press 0 --> Exit\n")
